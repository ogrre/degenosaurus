<template>
  <div class="bg-ground pt-1">
    <div class="container mx-auto py-3 px-5 flex flex-wrap flex-col sm:flex-row">
      ...
      <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start gap-4">
          <template v-for="network in networks">
            <a :href="network.slug" class="cursor-pointer" target="_blank" rel="noopener noreferrer">
             <svg v-if="network.name === 'instagram'" class="fill-ivory hover:fill-ivory/80 cursor-pointer w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <svg v-else-if="network.name === 'twitter'" class="fill-ivory hover:fill-ivory/80 cursor-pointer w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              ...
              <svg v-else-if="network.name === 'discord'" class="fill-ivory hover:fill-ivory/80 cursor-pointer w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
              ...
              <svg v-else class="fill-ivory hover:fill-ivory/80 cursor-pointer w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
  ...
  data() {
    return {
      networks: [
        ...
        {name: 'discord', slug: 'https://discord.gg/zGdyRf5v', icon: '/svg/discord-brands.svg'},
